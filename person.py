...
def vis_segmentation(image, seg_map):
  ...
  b = np.zeros([len(seg_map),len(seg_map[0])])
  ...
  people_image = label_to_color_image(b).astype(np.uint8)
...
print('SAMPLE_IMAGE ={}'.format(SAMPLE_IMAGE))
...
print('_SAMPLE_URL = {}'.format(_SAMPLE_URL))
...
def run_visualization(url):
  ...
  try:
    ...
    jpeg_str = f.read()
    #print('jpeg_str {}'.format(jpeg_str))
